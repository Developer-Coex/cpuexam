...
$tmx['hp_login']='In order to access the different sections of CPUExam you must log in using the name and password provided to you by the system administrator';
$tmx['hp_online_users']='This form shows the users currently logged';
$tmx['hp_public_index']='This is the main page of CPUExam. From this page you can start or continue your tests';
...
$tmx['t_page_guide']='CPUExam :: Help';
$tmx['t_page_info']='About CPUExam';
$tmx['t_public_index']='CPUExam :: Test Execution';
...
$tmx['m_email_registration']='<?xml version="1.0" encoding="UTF-8"?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" dir="ltr"><body><p>This is an automated response to verify a <a href="#CPUExamURL#">CPUExam</a> New User Registration Request.<br />Request verification for email #EMAIL# submitted by remote IP #USERIP#.<br />If this message has been sent in error, please disregard.<br /><br /><b>TO CONFIRM THE REGISTRATION USE THE FOLLOWING LINK:<br /><a href="#SUBSCRIBEURL#">#SUBSCRIBEURL#</a></b></p></body></html>';
...
Push the [backup] button to create a new CPUExam database dump in compressed SQL format (structure and data).
...
Backup files are stored on the "cache/backup" folder using the following syntax: YYYYMMDDhhmmss_CPUExam_backup.sql.gz , where YYYYMMDDhhmmss are the digits of year (Y), month (M), day (D), hour (h), minutes (m), seconds (s).';
$tmx['w_download']='download';
$tmx['h_download']='download the selected backup file';
$tmx['t_user_change_w_test']='Change w_test';
...
$tmx['m_otp_qrcode']='CPUExam uses a 2-step verification process that requires you to enter two pieces of information before you can access the system. The required information is the standard CPUExam password and the verification code generated by your smartphone. This prevents hackers from accessing your account if they only have your password or phone. However, it also means that you will always need to have your phone at hand whenever you want to login to your CPUExam Account.<br /><br />You must download and install the <a href="https://support.google.com/accounts/answer/1066447" title="Install Google Authenticator">Google Authenticator</a> app on your smartphone. When you have downloaded and installed the app you can use the following code, or scan the QR-Code:';
